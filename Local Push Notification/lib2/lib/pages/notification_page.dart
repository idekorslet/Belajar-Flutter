...
class NotificationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final createdAt = receivedAction == null ? notifData?.createdAt : receivedAction?.payload?['createdAt'];
    final notifSchedule = receivedAction == null ? notifData?.notifSchedule : receivedAction?.payload?['notifSchedule'];
